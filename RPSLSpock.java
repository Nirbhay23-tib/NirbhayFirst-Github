...
/**
 * Base Rock, Paper, Scissors, Lizard and Spock class and methods
 * @author Nirbhay Tibadiya
 * @version 1.0
 */
public class RPSLSpock {
    ...
    /**
     * isValidPick() method checks the pick is valid, spaces and ignoring case.
     * @param pick the choice of the user
     * @return valid input whether true or false
     */
    ...
    /**
     * This method generates computer's choice
     * @return the generated pick for computer
     */
    ...
    /**
     * checks if computer won against user's choice
     * @param c_pick computer's pick
     * @param h_pick user's pick
     * @return possible outcomes of choosing Rock, Paper, Scissors, Lizard and Spock by Computer and human pick
     */
